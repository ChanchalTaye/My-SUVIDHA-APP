...
const Water = () => {
    ...
    useEffect(() => {
        if (location.state?.prefill && location.state?.autoFetch) {
            ...
            // Auto fetch bill
            const bill = generateBillData('water', consumerId);
            setBillData(bill);
        }
    }, [location.state]);
    ...
    const handleFetchBill = () => {
        ...
        if (identifier.trim()) {
            const bill = generateBillData('water', identifier);
            setBillData(bill);
        }
    };
    ...
    const handleNewConnection = () => {
        ...
        navigate('/new-service-request?service=water', { state: { serviceType: 'water' } });
    };
    ...
    const serviceActions = [
        ...
        },
        {
            ...
            action: () => alert(mockServiceInfo.water.content.join('\n'))
        },
        {
            id: 'complaint',
                ...
                <Container>
                    ...
                    <div className="service-content">
                        <h1 className="service-title">
                            <img src="/assets/water.png" alt="Water" className="service-header-icon" />
                            {t('water')} - {t('viewBill')}
                        </h1>
