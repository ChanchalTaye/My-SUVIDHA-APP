...
const Electricity = () => {
    ...
    const [lookupMethod, setLookupMethod] = useState('consumer'); // 'consumer' or 'mobile'
    ...
    useEffect(() => {
        if (location.state?.prefill && location.state?.autoFetch) {
            ...
            // Auto fetch bill
            const bill = generateBillData('electricity', consumerId);
            setBillData(bill);
        }
    }, [location.state]);
    ...
    const [activeInput, setActiveInput] = useState(null); // 'consumer' or 'mobile'
    ...
    const handleFetchBill = () => {
        ...
        if (identifier.trim()) {
            const bill = generateBillData('electricity', identifier);
            setBillData(bill);
        }
    };
    ...
    const handleNewConnection = () => {
        ...
        navigate('/new-service-request?service=electricity', { state: { serviceType: 'electricity' } });
    };
    ...
    const serviceActions = [
        ...
        },
        {
            ...
            action: () => alert(mockServiceInfo.electricity.content.join('\n'))
        },
        {
            id: 'complaint',
                ...
                <Container>
                    ...
                    <div className="service-content">
                        <h1 className="service-title">
                            <img src="/assets/electricity.png" alt="Electricity" className="service-header-icon" />
                            {t('electricity')} - {t('viewBill')}
                        </h1>
                        ...
                        <Card className="bill-input-card">
                            ...
                            {lookupMethod === 'consumer' ? (
                                <>
                                    ...
                                    <p className="helper-text-example">
                                        Try: 1234567890 or 9876543210
                                    </p>
                                </>
                            ) : (
                                <>
